...
class NavegationBanned extends React.Component {
  render() {
    const { banned, prevPage, nextPage, limit, currentPage } = this.props;
    const { itemsRemaining, pagesRemaining } = banned;
...
export default NavegationBanned;